...
export default function App() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // MODIFICARE: Redirecționăm către scanner pentru a identifica afișul-ancoră [cite: 16]
    ...
    <View style={styles.container}>
      ...
      >
        <Text style={styles.linkText}>
          {/* REPARARE ESLint: Am escapat apostroful */}
          Don&apos;t have an account?{" "}
          <Text style={styles.linkTextBold}>Sign Up here</Text>
        </Text>
      </TouchableOpacity>
    </View>
  );
